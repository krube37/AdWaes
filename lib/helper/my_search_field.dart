...
class SearchField<T> extends StatefulWidget {
  ...
  final Function(String text, StreamController<List<SearchFieldListItem<T>?>?> suggestionStream)? onChanged;
            ...
            onChanged: (query) {
              ...
              if (widget.onChanged == null) {
                ...
                Future.delayed(const Duration(milliseconds: 150)).then((value) {
                  if (localEnqueuedState == onChangeEnqueuedTimes) {  // to prevent sending all the request to the
                    // firebase while user clicks and holds back button to clear search string
                    widget.onChanged!.call(query, suggestionStream);
                  }
                });
              }
            },
